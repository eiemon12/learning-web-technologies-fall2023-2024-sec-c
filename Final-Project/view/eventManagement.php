...
<head>
    ...
    <script>
        function validateEventForm() {
            var eventContent = document.forms["eventForm"]["event"].value;
            if (eventContent == "") {
                alert("Event content must be filled out");
                return false;
            }
        }
    </script>
...
<body>
    <table width="100%" height="100%" cellspacing="0" cellpadding="0" border="1">
        ...
        <tr>
            ...
            <td>
                <h3>
                <form action="eventManagement.php" method="post" name="eventForm" onsubmit="return validateEventForm()">
                    <textarea rows="2" name="event" placeholder="Post event here.."></textarea><br>
                ...
                while ($row = mysqli_fetch_array($result)) {
                    echo "<table width='100%'><tr><td width='5%'>" . $row['sl'] . "</td><td>" . $row['event'] . "</td></tr></table>";
                }
                ?>
            </td>
        </tr>
